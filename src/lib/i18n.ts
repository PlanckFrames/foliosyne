...
const en = {
  ...
  "file.blank": "New blank PDF",
  "file.blankHint": "Start with an empty page.",

  "edit.picture": "Picture",
  "edit.pictureHint": "Choose an image, then click the page to place it.",
  "edit.hex": "Hex",
  "edit.eyedrop": "Eyedropper",

  "color.page": "Page color",
  "color.hint": "Paper fill for this page. Ink stays. Use the eyedropper to sample a colour from the document.",
  "color.applyPage": "This page",
  "color.applyAll": "All pages",

  "save.title": "Save PDF",
  "save.hint": "Keep the current file size, or shrink resolution and compression together.",
  "save.keep": "Keep current file size",
  "save.pixels": "Resolution",
  "save.filesize": "File size",
  "save.download": "Download",
  "save.estimate": "About {n}",
  "save.original": "Original {n}",

  "empty.title": "A quieter studio for serious documents.",
  "empty.body": "Open a PDF or Word file, start a blank page, import from Drive, or try the sample.",
  ...
  "resize.title": "Page size",
  "resize.hint": "Choose a paper size. US Letter and Legal, ISO A-series (UK/EU), custom, plus portrait or landscape.",
  "resize.us": "US",
  "resize.iso": "ISO / UK",
  "resize.custom": "Custom",
  "resize.width": "Width",
  "resize.height": "Height",
  "resize.portrait": "Portrait",
  "resize.landscape": "Landscape",

  "margins.title": "Margins",
  "margins.hint": "Inset the page on all four sides. None is the default. Values are in inches or millimetres.",
  "margins.none": "None",
...
const es: Record<Msg, string> = {
  ...
  "file.blank": "Nuevo PDF en blanco",
  "file.blankHint": "Empiece con una página vacía.",
  "edit.picture": "Imagen",
  "edit.pictureHint": "Elija una imagen y pulse la página para colocarla.",
  "edit.hex": "Hex",
  "edit.eyedrop": "Cuentagotas",
  "color.page": "Color de página",
  "color.hint": "Rellena el papel de esta página. La tinta se mantiene. Use el cuentagotas para muestrear un color.",
  "color.applyPage": "Esta página",
  "color.applyAll": "Todas las páginas",
  "save.title": "Guardar PDF",
  "save.hint": "Conserve el tamaño actual o reduzca resolución y compresión a la vez.",
  "save.keep": "Conservar el tamaño actual",
  "save.pixels": "Resolución",
  "save.filesize": "Tamaño de archivo",
  "save.download": "Descargar",
  "save.estimate": "Aprox. {n}",
  "save.original": "Original {n}",
  ...
  "rotate.around": "180°",
  "resize.title": "Tamaño de página",
  "resize.hint": "Elija un tamaño de papel. Carta y Oficio de EE. UU., serie A ISO (Reino Unido/UE), personalizado, vertical u horizontal.",
  "resize.us": "EE. UU.",
  "resize.iso": "ISO / UK",
  "resize.custom": "Personalizado",
  "resize.width": "Ancho",
  "resize.height": "Alto",
  "resize.portrait": "Vertical",
  "resize.landscape": "Horizontal",
  "margins.title": "Márgenes",
  "margins.hint": "Ajuste los cuatro lados. Ninguno es el valor inicial. Pulgadas o milímetros.",
  "margins.none": "Ninguno",
  "margins.narrow": "Estrecho",
  "margins.normal": "Normal",
  "margins.wide": "Ancho",
  "margins.custom": "Personalizado",
  "margins.top": "Superior",
  "margins.bottom": "Inferior",
  "margins.left": "Izquierdo",
  "margins.right": "Derecho",
  "theme.light": "Claro",
  "theme.dark": "Oscuro",
...
const fr: Record<Msg, string> = {
  ...
  "file.blank": "Nouveau PDF vierge",
  "file.blankHint": "Commencez avec une page vide.",
  "edit.picture": "Image",
  "edit.pictureHint": "Choisissez une image, puis cliquez la page pour la poser.",
  "edit.hex": "Hex",
  "edit.eyedrop": "Pipette",
  "color.page": "Couleur de page",
  "color.hint": "Remplit le papier de cette page. L’encre reste. La pipette prélève une couleur du document.",
  "color.applyPage": "Cette page",
  "color.applyAll": "Toutes les pages",
  "save.title": "Enregistrer le PDF",
  "save.hint": "Gardez la taille actuelle, ou réduisez résolution et compression ensemble.",
  "save.keep": "Conserver la taille actuelle",
  "save.pixels": "Résolution",
  "save.filesize": "Taille du fichier",
  "save.download": "Télécharger",
  "save.estimate": "Environ {n}",
  "save.original": "Original {n}",
  ...
  "rotate.around": "180°",
  "resize.title": "Format de page",
  "resize.hint": "Choisissez un format. Letter et Legal US, série A ISO (UK/UE), personnalisé, portrait ou paysage.",
  "resize.us": "US",
  "resize.iso": "ISO / UK",
  "resize.custom": "Personnalisé",
  "resize.width": "Largeur",
  "resize.height": "Hauteur",
  "resize.portrait": "Portrait",
  "resize.landscape": "Paysage",
  "margins.title": "Marges",
  "margins.hint": "Décalage des quatre côtés. Aucune par défaut. Pouces ou millimètres.",
  "margins.none": "Aucune",
  "margins.narrow": "Étroite",
  "margins.normal": "Normale",
  "margins.wide": "Large",
  "margins.custom": "Personnalisé",
  "margins.top": "Haut",
  "margins.bottom": "Bas",
  "margins.left": "Gauche",
  "margins.right": "Droite",
  "theme.light": "Clair",
  "theme.dark": "Sombre",
