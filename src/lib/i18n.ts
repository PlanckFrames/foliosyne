...
const en = {
  ...
  "convert.hintWord": "Each PDF page becomes its own Word page. Text is real, selectable, and editable — layout, size, and position are preserved. Redacted text is removed.",
